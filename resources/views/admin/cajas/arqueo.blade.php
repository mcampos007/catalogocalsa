        ...
        <div class="section ">
            ...
            <div class="form-row" id="totales"> 
                <div class="input-group">
                    ...
                    <input type="text" name="total" id="totalbilletes" disabled value="0">
                </div> 
            </div> 
            <div class="form-row">
                <div class="row">
